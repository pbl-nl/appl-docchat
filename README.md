...
6. EVAL, RESEARCH, Ingestion (3): As a developer I want to determine the optimal settings for fixed-size chunking. Values of chunksize, chunk overlap and maximum number of chunks to add to context are available in see settings.py. Test the application performance of alternative settings of CHUNK_SIZE, CHUNK_OVERLAP and CHUNK_K. For inspiration: https://www.pinecone.io/learn/chunking-strategies/
...
19. FUNC, RESEARCH, evaluation: As a developer I want to know if we are missing other valuable performance metrics. Research added value of additional metrics like ROUGE, BLEU or BertScore and what is needed to implement them. For inspiration:, see<br>
...
27. FUNC, BUILD : As a developer I want to be able to chat with multiple documents at the same time and also be able to cross communicate between different documents.
