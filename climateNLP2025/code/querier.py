...
class Querier:
    ...
    def get_qa_template(self,
        ...
        elif retriever_prompt_template_setting == "json_en":
            current_template = pr.JSON_EXCESS_NUTRIENTS_TEMPLATE
        elif retriever_prompt_template_setting == "json_ps":
            current_template = pr.JSON_PESTICIDES_CHEMICALS_TEMPLATE
        elif retriever_prompt_template_setting == "json_pl":
            current_template = pr.JSON_PLASTICS_TEMPLATE
