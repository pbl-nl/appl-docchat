                ...
                def _get_docs(
                    ...
                    *,
                    ...
                    if isinstance(self.extra_context,list):
                        pages = list({num for doc in docs  for num in [doc.metadata['page_number'] - 1, doc.metadata['page_number'], doc.metadata['page_number']+1]})
                        ...
                        tables = [table for table, _ in self.extra_context if table.metadata.get('page_number') in pages]
